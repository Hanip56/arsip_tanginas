...
const NavMenu = () => {
  ...
  return (
    <div className="h-full w-full">
      ...
      {/* nav menu */}
      <div className="py-2 text-zinc-900 flex flex-col justify-between h-full  overflow-auto">
        <div className="flex flex-col py-2 pr-2 flex-1  gap-1 overflow-y-auto sm:px-4">
